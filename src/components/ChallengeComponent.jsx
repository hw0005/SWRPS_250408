            ...
            <div className="d-flex">
                <div>
                    ...
                    <p>
                        ...
                        닉네임: <input type="text" name="user-alias" id="user" 
                                value={user} onChange={handleChangeName} /><br/>
                        <input type="button" className="btn btn-primary" value="확인" onClick={handleSubmitResult} />
                    </p>
                    <div className="bg-info">
                        <h1>결과</h1>
                        <h2><span className="result-message">{message}</span></h2>
                    </div>
